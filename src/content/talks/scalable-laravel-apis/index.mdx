...
description: Join me for an engaging session where we will dive into the world of APIs. These aren't your grandparents APIs either, they are modern and scalable APIs built using Laravel with no additional packages.
